...
#   services.pia.authUserPass.username = "P4526333";
#   services.pia.authUserPass.password = "HideMyInternet42!";
#
...
#   # services.pia.authUserPassFile = "./pia.env" #config.sops.secrets.pia.path;
#   # services.pia.authUserPassFile = "./pia.env" #config.sops.secrets.pia.path;
# }
{ config, lib, pkgs, ... }:
let
