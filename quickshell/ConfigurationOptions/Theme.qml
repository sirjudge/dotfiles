...
QtObject {
    ...
    property color colorBackground: rosePineBase 
    property color colorForeground: rosePineText
    property color colorMuted: rosePineMuted
    // Even dimmer than muted — for the faintest UI marks (hairline underlines,
    // de-emphasised placeholders). Derived as the midpoint between muted and the
    // background so it stays low-contrast across themes.
    // readonly property color colorSubtle: Qt.rgba((colorMuted.r + colorBackground.r) / 2, (colorMuted.g + colorBackground.g) / 2, (colorMuted.b + colorBackground.b) / 2, 1)
    readonly property color colorSubtle: rosePineSubtle
    property color colorHighlight: "#fe8019"
    property color colorHighlightAlt: "#83a598"
    property color colorError: "#fb4934"
    property color colorWarning: rosePineLove 
    property color colorSuccess: rosePinePine 
    ...
    // Speaker glyph for the given volume level (0..1), or a muted glyph.
